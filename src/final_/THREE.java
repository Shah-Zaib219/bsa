...
public class THREE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DNA Sequence Analysis");
        ...
        jLabel4.setText("Complementry Strand");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("RNA Strand");
        ...
        jLabel7.setText("Protein/Amino Acid");
...
AMINO A=new AMINO();
        String dna;
dna =t0.getText();
t2.setText(""+D.length(dna));
t3.setText(D.Rep(dna));
t4.setText(D.Transc(dna));
t5.setText(A.Amino(t4.getText()));
